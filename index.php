...
<head>
    ...
    <title>Grocery</title>
    <link rel="shortcute icon" type="x-icon" href="https://askbootstrap.com/preview/vegishop/img/logo.png">
...
<body class="fixed-bottom-padding" style="background-color:whitesmoke;">
    ...
    <div class="border-bottom p-3 d-none mobile-nav">
        ...
        <a href="home.html" class="text-decoration-none text-dark d-flex align-items-center">
            <img class="osahan-logo mr-2" src="https://askbootstrap.com/preview/vegishop/img/logo.png">
...
<div class="btn-menu">
        ...
        <nav class="sidebar">
          <div class="text">gurdeeposahan</div>
          <ul>
            <li class="active"><a href="#">Home</a></li>
            <li>
              <a href="#" class="feat-btn"><i class="fas fa-sign-in-alt"></i>Authentication
                <span class="fas fa-caret-down first"></span>
              </a>
              <ul class="feat-show">
                <li><a href="#">gurdeeposahan</a></li>
            ...
            <li>
              <a href="#" class="serv-btn"
                ><i class="fas fa-list-ol"></i>My Order
                <span class="fas fa-caret-down second"></span>
              </a>
              <ul class="serv-show">
                <li><a href="#">gurdeeposahan</a></li>
                <li><a href="#">My order</a></li>
                <li><a href="#">Status on Process</a></li>
                <li><a href="#">Status Canceled</a></li>
                <li><a href="#">Status Complete</a></li>
                <li><a href="#">Review</a></li>
              </ul>
            </li>
            <li>
              <a href="#" class="three-btn"
                ><i class="fas fa-list-ol"></i>My Order
    ...
    <button class="border-0 btn btn-outline-secondary text-success bg-white"><i class="fas fa-search"></i></button>
    </div>
    ...
    <div class="bg-white shadow-sm osahan-main-nav">
        <nav class="navbar navbar-expand-lg navbar-light bg-white osahan-header py-0 container">
            <a class="navbar-brand mr-0" href="#"><img class="img-fluid logo-img "
                    src="https://askbootstrap.com/preview/vegishop/img/logo.png"></a>
            ...
            <div class="ml-3 d-flex align-items-center">
                <div class="dropdown">
                    <a class="text-dark dropdown-toggle d-flex align-items-center osahan-location-drop" href="#"
                        ...
                        aria-expanded="false">
                        <div class="mr-3">
                            <i class="fas fa-map-marker-alt  btn btn-icon btn-light "></i>
                        </div>
                        <div style="min-width: 130px;">
                            <p class=" mb-0 small">Select Location</p>
                            Maharashtra India...
                        </div>
                    </a>
            ...
            <div class="ml-auto d-flex align-items-center">
                <a href="#" data-toggle="modal" data-target="#login" class="mr-2">

                    <i class="fas fa-sign-in-alt  btn btn-icon btn-light"></i>

                </a>
                <div class="dropdown">
                    <a href="#" class="text-dark dropdown-toggle not-drop" id="dropdownMenuNotification"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-bell  btn btn-icon btn-light"></i>
                    </a>
                            ...
                            <a href="#" class="text-decoration-none text-dark">
                                <div class="notifiction small">
                                    <div class="ml-3">
                                        ...
                                        <p class="small m-0"><i class="far fa-calendar"></i> Today, 05:14 AM</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="text-decoration-none text-muted">
                                <div class="notifiction small">
                                    <div class="ml-3">
                                        ...
                                        <p class="small m-0"><i class="far fa-calendar"></i>Monday, 08:30 PM</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="text-decoration-none text-muted">
                                <div class="notifiction small">
                                    <div class="ml-3">
                                        ...
                                        <p class="small m-0"><i class="far fa-calendar"></i></i> Sunday, 10:30 AM</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <a href="#" class="ml-2">
                    ...
                    <i class="fas fa-shopping-cart btn btn-icon btn-light"></i>
                </a>
            </div>
        </nav>
            ...
            <div class="container menu-bar d-flex align-items-center">
                <ul class="list-unstyled form-inline mb-0">
                    <li class="nav-item active">
                        <a class="nav-link text-white pl-0" href="#">Home <span class="sr-only">(current)</span></a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link text-white dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Checkout Process</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="#">Status Complete</a>
                            <a class="dropdown-item" href="#">Status on Process</a>
                            <a class="dropdown-item" href="#">Status Canceled</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#">Verification</a>
                            <a class="dropdown-item" href="#">Promos</a>
                            <a class="dropdown-item" href="#">Promo Details</a>
                            <a class="dropdown-item" href="#">Terms & Conditions</a>
                            <a class="dropdown-item" href="#">Privacy</a>
                            <a class="dropdown-item" href="#">Conditions</a>
                            <a class="dropdown-item" href="#">Help Support</a>
                            <a class="dropdown-item" href="#">Help Ticket</a>
                            <a class="dropdown-item" href="#">Refund Payment</a>
    ...
    <div class="container">
        <div class="py-3 osahan-promos">
            <section class="section px-4" style="min-height: 168px;">
                <h5 class="pb-2 text-light">What do you looking for?</h5>
                <!-- Slider main container -->
                <div class="swiper row">
                    <!-- Additional required wrapper -->
                    <div class="thumbtitle swiper-wrapper">
                        <!-- Slides -->
                        <div class="px-2 swiper-slide ">
                       
                            <div class="bg-white rounded text-center slider-size ">
                                <a href="#">
                                    <img src="https://askbootstrap.com/preview/vegishop/img/categorie/1.svg "class="img-fluid px-2 mx-auto" >
                        ...
                        <div class="px-2 swiper-slide">
                            <div class="bg-white rounded text-center slider-size">
                                <a href="#">
                                    <img src="https://askbootstrap.com/preview/vegishop/img/categorie/3.svg"
                        ...
                        <div class="px-2 swiper-slide">
                            ...
                            <div class="bg-white rounded text-center slider-size">
                                <a href="#">
                                    <img src="https://askbootstrap.com/preview/vegishop/img/categorie/8.svg"
                                        class="img-fluid px-2 mx-auto">
                        ...
                        <div class="px-2 swiper-slide">
                            ...
                            <div class="bg-white rounded text-center slider-size">
                                <a href="#">
                                    <img src="https://askbootstrap.com/preview/vegishop/img/categorie/5.svg"
                                        class="img-fluid px-2 mx-auto">
                        ...
                        <div class="px-2 swiper-slide">
                            ...
                            <div class="bg-white rounded text-center slider-size">
                                <a href="#">
                                    <img src="https://askbootstrap.com/preview/vegishop/img/categorie/6.svg"
                                        class="img-fluid px-2 mx-auto">
                        ...
                        <div class="px-2 swiper-slide">
                            ...
                            <div class="bg-white rounded text-center slider-size">
                                <a href="#">
                                    <img src="https://askbootstrap.com/preview/vegishop/img/categorie/7.svg"
                                        class="img-fluid px-2 mx-auto">
    ...
    <div class="container">
        <div class="py-3 osahan-promos">
            ...
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <img src="https://askbootstrap.com/preview/vegishop/img/promo1.jpg" alt="">
                </div>
                <div class="item">
                    <img src="https://askbootstrap.com/preview/vegishop/img/promo2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="https://askbootstrap.com/preview/vegishop/img/promo4.jpg" alt="">
                </div>
                <div class="item">
                    <img src="https://askbootstrap.com/preview/vegishop/img/promo3.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="py-3 osahan-promos">
                        ...
                        <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    ...
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v1.jpg"class="img-fluid item-img w-100 mb-3">
                                        <h6>Chilli</h6>
                        ...
                        <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    ...
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v2.jpg"
                        ...
                        <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    ...
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v5.jpg"
                                            class="img-fluid item-img w-100 mb-3">
                                        <h6>Cauliflower</h6>
                                        <div class="d-flex align-items-center">
                                            <h6 class="price m-0 text-success">$1.8/kg</h6>
                            ...
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    <div class="member-plan position-absolute"><span
                                            class="badge m-3 badge-success">10%</span></div>
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v6.jpg"
                                            class="img-fluid item-img w-100 mb-3">
                                        <h6>Carrot</h6>
                                        <div class="d-flex align-items-center">
                                            <h6 class="price m-0 text-success">$0.8/kg</h6>
                        ...
                        <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    ...
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v3.jpg"
                                            class="img-fluid item-img w-100 mb-3">
                                        <h6>Tomato</h6>
                                        <div class="d-flex align-items-center">
                        ...
                        <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    ...
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v4.jpg"
                                            class="img-fluid item-img w-100 mb-3">
                                        <h6>Cabbage</h6>
                                        <div class="d-flex align-items-center">
                                            <h6 class="price m-0 text-success">$0.8/kg</h6>
                            ...
                            <div class="list-card-image">
                                <a href="#" class="text-dark">
                                    <div class="member-plan position-absolute"><span
                                            class="badge m-3 badge-danger">10%</span></div>
                                    <div class="p-3">
                                        <img src="https://askbootstrap.com/preview/vegishop/img/listing/v1.jpg"
                                            class="img-fluid item-img w-100 mb-3">
                                        <h6>Chilli</h6>
                                        <div class="d-flex align-items-center">
                                            <h6 class="price m-0 text-success">$0.8/kg</h6>
            ...
            <div class="title d-flex align-items-center py-3">
                ...
                <a class="ml-auto btn btn-outline-success btn-sm" href="#">26 more</a>
            </div>
                                        ...
                                        <div class="py-3 osahan-promos">
                                            <div class="carousel" data-flickity='{"autoPlay": true }'>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r1.jpg"
                                                        alt="" width="250px" />
                                                </div>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r3.jpg"
                                                        alt="" width="250px" />
                                                </div>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r2.jpg"
                                                        alt="" width="250px" />
                                                </div>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r1.jpg"
                                ...
                                <div class="recommend-slider2 rounded mb-0">
                                    <div class="osahan-slider-item">
                                        <div class="py-3 osahan-promos">
                                            <div class="carousel" data-flickity='{"autoPlay": true }'>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r4.jpg"
                                                        alt="" width="250px" />
                                                </div>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r6.jpg"
                                                        alt="" width="250px" />
                                                </div>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r5.jpg"
                                                        alt="" width="250px" />
                                                </div>
                                                <div class="carousel-cell test">
                                                    <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r1.jpg"
                                    ...
                                    <div class="osahan-slider-item">
                                        <div class="container">
                                            <div class="py-3 osahan-promos">
                                                <div class="carousel" data-flickity='{"autoPlay": true }'>
                                                    <div class="carousel-cell test">
                                                        <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r7.jpg"
                                                            alt="" width="250px" />
                                                    </div>
                                                    <div class="carousel-cell test">
                                                        <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r8.jpg"
                                                            alt="" width="250px" />
                                                    </div>
                                                    <div class="carousel-cell test">
                                                        <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r9.jpg"
                                                            alt="" width="250px" />
                                                    </div>
                                                    <div class="carousel-cell test">
                                                        <img src="https://askbootstrap.com/preview/vegishop/img/recommend/r1.jpg"
            ...
            <div class="container">
                <div class="row justify-content-center ">
                    <div class="col-md-4 usa">
                        ...
                        <form>
                            <select class="Unitedstarted">
                                <option value="United States">United States</option>
                                <option value="Russia">Russia</option>
                                <option value="fiat">Uzbekistan</option>
                    ...
                    <div class="col-md-4 text-md-right">
                        <a href="#" class="btn btn-icon btn-light"><i class="fab fa-facebook"></i></a>
                ...
                <div class="row">
                    <aside class="col-md">
                        ...
                        <ul class="list-unstyled list-padding">
                            ...
                            <li>
                                <a href="#" class="text-dark">Trending</a>
                            </li>
                            <li>
                                <a href="#" class="text-dark">Recommended</a>
                            </li>
                            <li>
                                <a href="#" class="text-dark">Most Popular</a>
                            </li>
                        </ul>
                    </aside>
                    <aside class="col-md">
                        ...
                        <ul class="list-unstyled list-padding">
                            ...
                            <li><a href="#" class="text-dark">Order Address</a></li>
                            <li><a href="#" class="text-dark">Delivery Time</a></li>
                            <li><a href="#" class="text-dark">Order Payment</a></li>
                            <li><a href="#" class="text-dark">Checkout</a></li>
                            <li>
                    ...
                    <aside class="col-md">
                        ...
                        <ul class="list-unstyled list-padding">
                            <li><a href="#" class="text-dark">My order</a></li>
                            <li>
                                <a href="#" class="text-dark">Status Complete</a>
                            </li>
                            <li>
                                <a href="#" class="text-dark">Status on Process</a>
                            </li>
                            <li>
                                <a href="#" class="text-dark">Status Canceled</a>
                            </li>
                            <li><a href="#" class="text-dark">Review</a></li>
                        </ul>
                    </aside>
                    <aside class="col-md">
                        ...
                        <ul class="list-unstyled list-padding">
                            ...
                            <li><a class="text-dark" href="#"> Promos</a></li>
                            <li>
                                <a class="text-dark" href="#"> My address</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="text-dark" href="#"> Help ticket</a>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-md-right">
                        <a href=""><img src="https://askbootstrap.com/preview/vegishop/img/appstore.png"
                                height="30" /></a>
                        <a href=""><img src="https://askbootstrap.com/preview/vegishop/img/playmarket.png"
                                height="30" /></a>
                    </div>
                </div>
            </div>
                  ...
                  " data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body p-0">
                            ...
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                ...
                                <div class="osahan-signin p-4 rounded">
                                    <div class="p-2">
                                        ...
                                        <a href="verification.html" class="
                        btn btn-light
                        border
                        btn-block
                        rounded
                      ...
                      ">
                                        ...
                                        <p class="text-center mt-3 mb-0">
                                            <a href="signin.html" class="text-dark">Already have an account! Sign in</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="tab-content" id="nav-tabContent">
                      ...
                      btn-lg btn-google
                    ">
                                        <i class="icofont-google-plus text-danger mr-2"></i> Sign
                                        up with Google
                                    </a>
                                    <p class="text-center mt-3 mb-0">
                                        <a href="signup.html" class="text-dark">Don't have an account? Sign up</a>
